...
Drawing = Drawing
upadokvelikolepiya = upadokvelikolepiya
setfpscap = setfpscap
syn = syn
...
local UiLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Definezzz/xyz/main/UiLib.lua"))()
...
StatsTop.Name = "upadokvelikolepiya"
...
StatsName.Name = "upadokvelikolepiya"
...
StatsPicture.Name = "upadokvelikolepiya"
...
StatsHealthBackground.Name = "upadokvelikolepiya"
...
StatsHealthBar.Name = "upadokvelikolepiya"
...
UiLib:CheckErrors(true, true, LocalPlr, __, upadokvelikolepiya)

-- Window

local upadokvelikolepiya = UiLib:CreateWindow("define | .gg/definegui", Vector2.new(500, 600), Enum.KeyCode.RightShift)

-- Tabs

local MainTab = upadokvelikolepiya:CreateTab("Main")
local MiscTab = upadokvelikolepiya:CreateTab("Misc")
